...
```bash
uvicorn swiss_company_intel.api:app --reload
```

Main endpoints:

- `GET /health` — service health check
- `POST /score` — calculate an explainable score for one set of metrics
- `POST /analyze` — analyze and rank a portfolio of companies
